...
| 问题 | 实际命中举例 | 影响 |
| --- | --- | --- |
| 真实银行账号 | `<账户号样例001>`、`<账户号样例002>` 等 10+ 个账号 | 客户账户信息泄露风险 |
| 真实银行支行 | `银行A_支行01`、`银行B_支行02` 等 9 家 | 客户合作银行信息泄露 |
| 真实客户名 | `客户A`、`客户B`、`客户C` 等 30+ 家 | 客户名单泄露 |
| 真实供应商名 | `供应商A`、`供应商B`、`供应商C` 等 | 供应商合作信息泄露 |
| 真实员工姓名 | `员工001`、`员工002`、`员工003` 等 31 人 | 员工隐私泄露 |
| 真实项目名 | `项目P001`、`项目P002`、`不动产权证样例001` | 项目信息泄露 |
